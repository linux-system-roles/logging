## fluentd/fluentd-outputs

This role configures fluentd logs collection, transformation and output plugin.
It can configure elasticsearch output plugin(Default), secure_forward plugin or to a file(Use debugging only).
