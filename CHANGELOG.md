...
- ci: bump actions/checkout from 6 to 7 (#507)
- ci: Use our own pr_title_lint.py instead of NPM commitlint [citest_skip] (#508)
- ci: bump tox-lsr version to 3.20.0 to fix tox 4.58 api breakage [citest_skip] (#509)
- ci: Add support for Fedora 44 and drop Fedora 42 - use ansible-core 2.21 [citest_skip] (#511)
- ci: bump actions/setup-python from 6 to 7 (#512)
- ci: ensure dependabot updates do not invoke ci tests [citest_skip] (#513)
...
- ci: bump actions/github-script from 8 to 9 (#501)
- refactor: use ansible.posix 2.1.X for EL7 compatibility [citest_skip] (#502)
- ci: Add config file for CodeRabbit with custom rules (#503)
- ci: Skip reviews for PRs with [citest_skip] in the title (#504)
- test: remove unused files [citest_skip] (#505)
